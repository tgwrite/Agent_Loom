# Advanced Agent contracts and compatibility

New users should start with the [user manual](README.md), then the complete
[native integration tutorial](NATIVE_INTEGRATION.md). This chapter retains detailed
contract and version notes; it is not the onboarding sequence.
