...
```sh
npm install --global ./agent-loom-0.1.0-alpha.2.tgz --offline --ignore-scripts --no-audit --no-fund
loom --version
loom --help
```
...
```sh
npm init -y
npm install ./agent-loom-0.1.0-alpha.2.tgz --save-exact --offline --ignore-scripts --no-audit --no-fund
